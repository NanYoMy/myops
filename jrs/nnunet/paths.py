...
os.environ['nnUNet_raw_data_base'] = '../outputs/nnunet/raw/'
os.environ['nnUNet_preprocessed'] = '../outputs/nnunet/prepro/'
os.environ['RESULTS_FOLDER'] = '../outputs/nnunet/output/'
...
# base = "../output/rcunet/raw_data_base"
# preprocessing_output_dir =  "../output/rcunet/preprocessed"
# network_training_output_dir_base =  "../output/rcunet/res"
